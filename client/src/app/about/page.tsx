...
const About: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1493815793585-d94ccbc86df8?q=80&w=773&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r  backdrop-blur-xs"></div>
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              About <span className="text-green-300">Green Mert</span>
            </h1>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <motion.div 
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-green-300/50 backdrop-blur-sm"></div>
                ...
                {milestones.map((milestone, index) => (
                  ...
                  >
                    <div className="md:w-1/2 flex justify-center md:justify-end md:pr-12 mb-4 md:mb-0">
                      <div className="bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-lg max-w-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300"
                >
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="bg-gradient-to-r   backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  ...
                  >
                    <div className="text-5xl mb-4 text-white">{stat.icon}</div>
